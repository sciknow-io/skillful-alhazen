...
import { PhaseOverview } from '@/components/domain-modeling/phase-overview';
import { GapsList } from '@/components/domain-modeling/gaps-list';
import { DecisionsList } from '@/components/domain-modeling/decisions-list';
import type { Gap } from '@/components/domain-modeling/gaps-list';
import type { Decision } from '@/components/domain-modeling/decisions-list';
  ...
  const fetchData = useCallback(async () => {
    ...
    try {
      const [detailRes, gapsRes] = await Promise.all([
        fetch(`/api/domain-modeling/domain/${id}`),
        fetch(`/api/domain-modeling/domain/${id}/gaps`),
      ]);
