...
import { ArrowLeft, RefreshCw, Puzzle, Server, Code2 } from 'lucide-react';
import { CategoryBadge, TypeBadge, LanguageBadge } from '@/components/techrecon/badges';
...
export default function ComponentPage({ params }: ComponentPageProps) {
  ...
  const snippets = data.component?.snippets || [];
            ...
            <CardContent className="space-y-4">
              ...
              {snippets.map((s: any, idx: number) => (
                <div key={s.id || idx}>
                  ...
                  {idx < snippets.length - 1 && <Separator className="mt-3" />}
                </div>
              ))}
            </CardContent>
          </Card>
